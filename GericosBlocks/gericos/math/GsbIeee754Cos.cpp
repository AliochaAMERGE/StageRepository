...
/************************************************************************
 *
 *  @file GsbIeee754Cos.cpp
 *  @brief Implementation of the GsbIeee754::cos() function.
 *
...
double GsbIeee754::cos(double x) {
	double rem[2];
	int32_t n;
	int32_t highWord;
	...
	if (highWord <= 0x3FE921FB) {
		if (highWord < 0x3E46A09E) {
			...
			result = GsbIeee754::kernelCos(x, 0.0);
		}
	}
