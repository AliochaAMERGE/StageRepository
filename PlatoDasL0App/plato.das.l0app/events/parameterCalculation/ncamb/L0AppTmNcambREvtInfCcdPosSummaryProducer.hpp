...
/************************************************************************
 ...
 L0AppTmNcambREvtInfCcdPosSummaryProducer.hpp
...
/************************************************************************
 ...
 L0AppTmNcambREvtInfCcdPosSummaryProducer.hpp									0.1.0.0
...
#ifndef L0APPTMNCAMBREVTINFCCDPOSSUMMARYPRODUCER_HPP_
#define L0APPTMNCAMBREVTINFCCDPOSSUMMARYPRODUCER_HPP_
			...
			namespace events {
				namespace parameterCalculation {
					namespace ncamb {
						 ...
						 */
						typedef TmNcamREvtInfCcdPosSummaryProducer<cameraIdentifier::NCAM_B> TmNcambREvtInfCcdPosSummaryProducer;
					}
				}
			}
		}
...
using plato::das::l0app::events::parameterCalculation::ncamb::TmNcambREvtInfCcdPosSummaryProducer;

#endif /* L0APPTMNCAMBREVTINFCCDPOSSUMMARYPRODUCER_HPP_ */
